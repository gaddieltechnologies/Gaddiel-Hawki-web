				...
				<!-- /Content -->
					<div class="span12">
						...
						<div class="widget-content">
							...
							<div class="span5"><input type="text" class="span5" placeholder="Search by Code"  id="searchname" name="ClientCategoryCode"/></div>               
							<div class="span4"><input type="text" class="span4" placeholder="Search by Client Category" id="searchphone" name="ClientCategory"/></div>                          
							<div class="span2"> 
							<input type="submit" class="btn btn-info " onClick="searchvalue()" value="Search"> <a href="#" class="btn btn-info " onClick="clearvalue()">Clear</a></div>   
					...
					<div class="widget-content">
						<div class="tab-content">
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								if ( !empty($_POST)) {	
								    $ID = $_POST['ClientCategoryCode'];
			                        $CLIENT_CATEGORY = $_POST['ClientCategory'];									
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT  ID,CLIENT_CATEGORY,DESCRIPTION FROM CLIENT_CATEGORY WHERE ID LIKE :ClientCategoryCode AND CLIENT_CATEGORY LIKE :ClientCategory;";
									$result=$pdo->prepare($sql);
									$result->bindValue(':ClientCategoryCode',$ID.'%');
