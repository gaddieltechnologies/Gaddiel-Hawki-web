...
include($_SERVER['DOCUMENT_ROOT'].'/php/fpdf/fpdf.php');
...
$pdf->SetFont('Arial', 'I');
$pdf->SetX(140);
$pdf->Cell(200, 15, $_POST['ID'], 0, 2);
$pdf->Cell(200, 15, $_POST['CLIENT_CATEGORY'] . ',' . $_POST['City'] , 0, 2);
$pdf->Cell(200, 15, $_POST['DESCRIPTION'], 0, 2);
