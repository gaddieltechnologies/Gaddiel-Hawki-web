 ...
 <?php include($_SERVER['DOCUMENT_ROOT'].'/php/pages/header.php'); ?>
	...
	<div id="main-content">
		...
		<div class="row">
				...
				<!-- Content -->
		<div class="span12">
			<h1 class="page-title">House Keeping<label class="pull-right"><a href="dashBoard.php"><h5><font color="#FFFFFF">Back to Dash Board</font></h5></a> </label> </h1>
				<div class="widget">						
					<div class="widget-content">
					<div class="box-container">
							
							<div class="box-holder">
                                <a href="housekeeping/clientcategory/clientCategory.php">
								<div class="box" style="height:60px;"></br>Client Category </div>
								</a>                            
							</div>							
							<div class="box-holder">						
                                <a href="housekeeping/clientclass/clientClass.php">
								<div class="box" style="height:60px;"></br>Client Class </div>
                                </a>                            
							</div>  
							<div class="box-holder">						
								<a href="housekeeping/clientclassification/clientClassification.php">
								<div class="box" style="height:60px;"></br>Client Classification</div>
                                </a>							
							</div>
								<div class="box-holder">
                                <a href="housekeeping/purpose/purposeManager.php">
						...
						<div class="box-container">
							...
							<div class="box-holder">						
                                <a href="housekeeping/activities/activity.php">
								<div class="box" style="height:60px;"></br>Visit Activity Details </div>
                                </a>                            
							</div>  
							<div class="box-holder">						
								<a href="housekeeping/scheduleperiod/visitSchedulePeriods.php">
